...
class _ButtonState extends State<Button> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    Widget icon = widget.leading ??
        CachedNetworkImage(
          width: 20,
          color: widget.active !=null && widget.active! ? Colors.white: MyColor.getPrimaryColor(),
          // imageUrl:"https://url8.viserlab.com/webview/assets/social_icon/64e4b137e6fd51692709175.png",
