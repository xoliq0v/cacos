...
class Dimensions{
  ...
  static const double socialIconSize           = 27;
  static const double socialIconSpace          = 20;
  static const double qrCodeAlertDialogHeight  = 250;
  ...
  static const EdgeInsets drawerPaddingHV        = EdgeInsets.symmetric(vertical  : 17                           , horizontal: 20);
  
  
  static const EdgeInsets onBoardPadding          = EdgeInsets.all(40);
  static const EdgeInsets floatingButtonPadding   = EdgeInsets.symmetric(horizontal: 20, vertical: 10);
  static const EdgeInsets navBarPadding           = EdgeInsets.only(top : 8, bottom  : 3 , left: 10, right: 10);
  static const EdgeInsets textFieldContentPadding = EdgeInsets.symmetric(horizontal: Dimensions.space20, vertical: Dimensions.space20);
  static const EdgeInsets drawerMenuPadding       = EdgeInsets.only(left: 20,bottom: 10);
