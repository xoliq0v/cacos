class UrlContainer {
  ...
  static const String obsContentEndPoint = 'obs-content';
  static const String navBarEndPoint = 'navbar';
  static const String drawerEndPoint = 'drawer';
  static const String floatingEndPoint = 'floating/button';
  static const String adsEndPoint = 'ads';
  static const String popUpAddsEndPoint = 'ads/pop-up';
  static const String socialMediaEndPoint = 'social-media';
  static const String languageEndPoint = 'language/all';
  static const String languageUrl = 'api/language/';
  static const String pushNotificationEndPoint = '/get/device/token';

  static const String appLink = 'https://play.google.com/store/apps/details?id=dev.vlab.xcash_user';
